...
forbidden='(^|/)(\.env$|\.env\.local$|\.env\.(development|production|test|preview|staging)$|\.env\..*\.local$|\.git/|node_modules/|\.output/|dist/|dist-ssr/|supabase/\.temp/|supabase/\.branches/|supabase/snippets/|backups/|exports/|.*\.log$|.*\.zip$)'
